...
import { PRICE_FROM_YEAR, PRICE_FROM_MONTH, TRIAL_DAYS, waUrl } from "@/lib/constants";
...
const COMPARE = [
  ...
  { k: "التكلفة", kairos: `تبدأ من ${PRICE_FROM_YEAR} ديناراً في السنة (≈${PRICE_FROM_MONTH} شهرياً) — بلا رسوم تفعيل`, other: "أعلى بشكل ملحوظ حسب الباقة" },
];
...
const FAQ = [
  ...
  },
  {
    ...
    a: `بحسب حالتك، تكون تكلفة كايروس سبيس أقل بنحو 60–75٪ من الأنظمة العالمية، مع أسعار بالدينار الأردني بلا رسوم تفعيل واشتراك سنوي يبدأ من ${PRICE_FROM_YEAR} ديناراً في السنة.`,
  },
  {
      ...
      <main className="max-w-[900px] mx-auto px-7 relative z-1 pt-[130px]">
        ...
        <section className="mt-12 reveal">
          ...
          <div className="mt-6 grid sm:grid-cols-2 gap-4">
            {[
              { t: "سعر بالدينار بلا مفاجآت", d: `اشتراك سنوي يبدأ من ${PRICE_FROM_YEAR} ديناراً، بلا رسوم تفعيل وبلا فواتير بالدولار.` },
