...
import { PRICES, TRIAL_DAYS, waUrl } from "@/lib/constants";
...
const COMPARE = [
  ...
  { k: "التكلفة", kairos: `تبدأ من ${PRICES.monthly} ديناراً شهرياً — بلا رسوم تفعيل`, other: "أعلى بشكل ملحوظ حسب الباقة" },
];
...
const FAQ = [
  ...
  },
  {
    ...
    a: "بحسب حالتك، تكون تكلفة كايروس سبيس أقل بنحو 60–75٪ من الأنظمة العالمية، مع أسعار بالدينار الأردني بلا رسوم تفعيل واشتراك يبدأ من 15 ديناراً شهرياً.",
  },
  {
      ...
      <main className="max-w-[900px] mx-auto px-7 relative z-1 pt-[130px]">
        ...
        <section className="mt-12 reveal">
          ...
          <div className="mt-6 grid sm:grid-cols-2 gap-4">
            {[
              { t: "سعر بالدينار بلا مفاجآت", d: "اشتراك يبدأ من 15 ديناراً شهرياً، بلا رسوم تفعيل وبلا فواتير بالدولار." },
