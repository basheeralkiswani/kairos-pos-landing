...
export default function HomeSignup() {
  return (
    <section className="section-sm scroll-mt-[104px]" id="lead-form">
      <div className="shell max-w-[640px]">
        <div className="text-center mb-10 reveal">
          ...
          <p className="text-base text-muted">
            املأ النموذج ونرسل بيانات الدخول على بريدك — بلا بطاقة ائتمان.
          </p>
        </div>
        ...
        <p className="text-center text-sm text-muted mt-7 reveal">
          تفضّل تحكي مع حدا؟{" "}
          <a
